        ...
        var makeRequest = function makeRequest(entity, index) {
          ...
          promise.done(function (successData) {
            ...
            if (cassandraError) {
              ...
              xhrData.errors.push(link + ': ' + $.i18n('api-error', endpoint.upcase() + ' API') + ' - ' + errorData.responseJSON.title);
            }
          }).always(function () {
...
var SiteViews = function (_mix$with) {
  ...
  _createClass(SiteViews, [{
    ...
    value: function pushParams() {
      var sites = this.isAllProjects() ? ['all-projects'] : $(this.config.select2Input).select2('val') || [];
    ...
    value: function setupDataSourceSelector() {
      ...
      $(this.config.dataSourceSelector).on('change', function (e) {
        var platform = $(_this5.config.platformSelector).val() || '',
            wasMobileValue = platform.includes('mobile'),
            wasPagecounts = _this5.params ? _this5.params.includes('pagecounts') : false;
        ...
        if (wasMobileValue && !_this5.isPageviews()) {
        ...
        if (_this5.isPagecounts() || wasPagecounts) {
          _this5.setupDateRangeSelector();
    ...
    value: function setupListeners() {
      ...
      $('.all-projects-radio').on('change', function (e) {
        ...
        if (e.target.value === '0' && !$(config.select2Input).select2('val')) {
          _this6.resetView();
          return _this6.setSelect2Defaults(config.defaults.projects);
        }
    ...
    value: function processInput(force, removedSite) {
      ...
      var sites = this.isAllProjects() ? ['all-projects'] : $(config.select2Input).select2('val') || [];
...
var templates = {
  chartLegend: function chartLegend(scope) {
    ...
    var dataList = function dataList(entity) {
      ...
      var infoHash = _defineProperty({}, pageviewsMsg, (_pageviewsMsg = {}, _defineProperty(_pageviewsMsg, pageviewsMsg, scope.formatNumber(entity.sum)), _defineProperty(_pageviewsMsg, $.i18n('daily-average'), scope.formatNumber(entity.average)), _pageviewsMsg));
