...
var TopViews = function (_Pv) {
  ...
  _createClass(TopViews, [{
    ...
    value: function addExclude(pages) {
      ...
      if (triggerChange) {
        (function () {
          _this3.setState('processing');

          // get edit data and mobile views for the new page that has come into view
          var newPage = _this3.pageData[_this3.offsetEnd].article;

          _this3.setSingleEditData(newPage).always(function () {
    ...
    value: function exportCSV() {
      ...
      var csvContent = 'data:text/csv;charset=utf-8,Page,Edits,Editors,Views' + (this.shouldShowMobile() ? ',Mobile views' : '') + '\n';
    ...
    value: function setSingleEditData(page) {
      ...
      var _getDates4 = _slicedToArray(_getDates3, 2);

      var startDate = _getDates4[0];
      var endDate = _getDates4[1];
    ...
    value: function setEditData() {
      ...
      var _getDates5 = this.getDates();

      var _getDates6 = _slicedToArray(_getDates5, 2);

      var startDate = _getDates6[0];
      var endDate = _getDates6[1];
    ...
    value: function setSingleMobileViews(page) {
      ...
      var _getDates8 = _slicedToArray(_getDates7, 2);

      var startDate = _getDates8[0];
      var endDate = _getDates8[1];
    ...
    value: function setMobileViews() {
      ...
      var _getDates10 = _slicedToArray(_getDates9, 2);

      var startDate = _getDates10[0];
      var endDate = _getDates10[1];
