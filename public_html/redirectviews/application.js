  ...
  _createClass(RedirectViews, [{
    ...
    value: function renderData() {
      ...
      _get(RedirectViews.prototype.__proto__ || Object.getPrototypeOf(RedirectViews.prototype), 'renderData', this).call(this, function (sortedDatasets) {
        var numRedirects = _this5.outputData.titles.length - 1;
        $('.output-totals').html('<th scope=\'row\'>' + $.i18n('totals') + '</th>\n         <th>' + $.i18n('num-redirects', _this5.formatNumber(numRedirects), numRedirects) + '</th>\n         <th>' + $.i18n('num-sections', _this5.formatNumber(_this5.outputData.sectionCount), _this5.outputData.sectionCount) + '</th>\n         <th>' + _this5.formatNumber(_this5.outputData.sum) + '</th>\n         <th>' + _this5.formatNumber(Math.round(_this5.outputData.average)) + '</th>');
        $('#output_list').html('');
        ...
        sortedDatasets.forEach(function (item, index) {
          ...
          if (item.section) {
            sectionMarkup = _this5.getPageLink(_this5.outputData.source, _this5.project, '#' + item.section, item.section);
          }

          $('#output_list').append('<tr>\n           <th scope=\'row\'>' + (index + 1) + '</th>\n           <td>\n             ' + _this5.getPageLink(item.label, _this5.project + '.org') + '\n             ' + (isSource ? '(' + $.i18n('target') + ')' : '') + '\n           </td>\n           <td>' + sectionMarkup + '</a></td>\n           <td><a target=\'_blank\' href=\'' + _this5.getPageviewsURL(_this5.project + '.org', item.label) + '\'>' + _this5.formatNumber(item.sum) + '</a></td>\n           <td>' + _this5.formatNumber(Math.round(item.average)) + '</td>\n           </tr>');
        });
      });
    }
